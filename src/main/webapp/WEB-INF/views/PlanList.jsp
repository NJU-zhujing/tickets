...
<div class="wrapper">
    <div class="top-s">
        <div class="top-con">
            <ul class="fl">
                <li class="dm-info" id="headerUserinfo"><span class="dm-name">HI, 欢迎来小麦</span>
    ...
    <div class="miannav-wrap">
        <div class="miannav clear">
            <div class="sort">
                <div class="sort-ti">
                    <a target="_blank" href="javascript:void(0)">商品分类</a>
                </div>
            </div>
            <ul>
                <li>
                    <a href="//www.damai.cn/">体育</a>
                </li>
                <li>
                    <a href="//rock.damai.cn/">音乐</a>
                </li>
                <li>
                    <a href="//drama.damai.cn/">舞蹈</a>
                </li>
                <li>
                    <a href="//sports.damai.cn/">戏剧</a>
                </li>
                <li>
                    <a href="//kids.damai.cn/">电竞</a>
                </li>
            </ul>
        </div>
    </div>
                ...
                <div class="search_main">
                    <div class="search_sort">
                        ...
                        <ul class="search_sort_way">
                            <li><a id="search_xgj"  class="active" href="javascript:void(0)" >最新上架</a></li>
                            <li><a id="search_ycsj"  href="javascript:void(0)">最近开场</a></li>
                        </ul>
                    </div>
                    ...
                    <ul class="search_list" id="content_list">
                        ...
                        <li onclick="">
                            <div class="search_txt"><h3>${planPO.name}</h3>
                                <p class="search_txt_cut c3">${planPO.introduction}</p>
                                ...
                                <button id="createOrder" class="btn05" type="button" name="createOrder"><a href="/order/createInfo?planId=${planPO.id}" >选座</a></button>
